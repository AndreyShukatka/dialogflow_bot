...
def create_intent(dialogflow_id, display_name, training_phrases_parts, message_texts):
...
if __name__ == '__main__':
    ...
    for display_name in questions:
        ...
        create_intent(dialogflow_id, display_name, training_phrases_parts, message_texts)
